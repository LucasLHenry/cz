...
FILE_NAME = "pitch_lut.h"
TABLE_LEN = 1024

MIN_PITCH = 20
MAX_PITCH = 4000

file_header = """// autogenerated by scripts/generate_pitch.py
// do not modify!!
#include<stdint.h>
#ifndef TABLES_PITCH_LUT_H_
#define TABLES_PITCH_LUT_H_
"""

array_footer = "};\n"
file_footer = "#endif  // TABLES_PITCH_LUT_H_"

def main():
    file_path = f"{os.getcwd()}{PATH_TO_TABLES}{FILE_NAME}"
    with open(file_path, 'w') as f:
        f.write(file_header)
        f.write(f"const float pitch_lut[{TABLE_LEN}] = {{\n")
